...
security_group_public_name        = "sg-jmeter-server-public"

vpc_name                          = "vpc-jmeter-server"
vpc_cidr                          = "10.2.0.0/16"
dns_list                          = ["100.125.1.250", "100.125.21.250"]

vpc_subnet_public_name            = "vpc-subnet-jmeter-server-public"
vpc_subnet_public_cidr            = "10.2.32.0/19"
vpc_subnet_public_gateway_ip      = "10.2.32.1"

ecs_public_name                   = "ecs-jmeter-server"